...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $insert_barang_sql = "INSERT INTO data_barang (
        ...
        no_rangka, no_bpkb, bahan, no_mesin, no_polisi, masa_stnk, masa_no_polisi, tgl_bayar_stnk, tgl_bayar_no_polisi, status_stnk, status_no_polisi, kondisi_barang, masa_manfaat, 
