...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    do {
        ...
        $new_id_jadwal_kendaraan = 'VHC' . str_pad($number, 8, '0', STR_PAD_LEFT);
        
        // Cek apakah ID yang dihasilkan sudah ada
        $check_query = "SELECT COUNT(*) as count FROM jadwal_kendaraan WHERE id_jadwal_kendaraan = '$new_id_jadwal_kendaraan'";
        ...
        if ($loop_count > $max_loop) {
            ...
            header('Location: ../../jd_frm_tambah_kendaraan.php');
            exit();
        }
    ...
    $query = "INSERT INTO jadwal_kendaraan (id_jadwal_kendaraan, id_barang_pemda, kendaraan, tgl_mulai, waktu_mulai, tgl_selesai, waktu_selesai, acara, pengguna, penanggungjawab)
    VALUES ('$new_id_jadwal_kendaraan', '$id_barang_pemda', '$kendaraan', '$tgl_mulai', '$waktu_mulai', '$tgl_selesai', '$waktu_selesai', '$acara', '$pengguna', '$penanggungjawab')";
