...
<main id="main" class="main">
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="jd_frm_tambah_kendaraan.php" class="btn btn-primary" title ='Tambah Penggunaan'>
  ...
  <table class="table table-bordered" style="font-size: 14px;">
    ...
    <tbody>
      ...
      $query_count = "SELECT COUNT(*) AS total_records FROM jadwal_kendaraan" . $search_query . $date_filter_query;
      ...
      $query = "SELECT * FROM jadwal_kendaraan
      $search_query
      $date_filter_query
      ...
      if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          <button class='btn btn-danger btn-sm btn-hapus' data-id_jadwal_kendaraan='{$row['id_jadwal_kendaraan']}' title='Hapus'>
...
$(document).ready(function() {
    ...
    $('.btn-hapus').on('click', function() {
        // Ambil id_jadwal_kendaraan dari atribut data
        var id_jadwal_kendaraan = $(this).data('id_jadwal_kendaraan');
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = 'proses/jadwal/jd_hapus_kendaraan.php?id_jadwal_kendaraan=' + id_jadwal_kendaraan;
            }
        });
    });
});
