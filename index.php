      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
        ...
        <div class="carousel-inner" style="height: 100vh;">
          ...
          <div class="carousel-item active">
            <img src="assets/assets/img/lahbrebes.jpg" class="d-block w-100" style="height: 100vh; object-fit: cover;"
              alt="Hero Image">
          </div>
          <!-- Slide 2 -->
          <div class="carousel-item">
            <img src="assets/assets/img/halamandepan.jpg" class="d-block w-100"
              style="height: 100vh; object-fit: cover;" alt="Second Slide">
          </div>
          <!-- Slide 3 -->
          <div class="carousel-item">
            <img src="assets/assets/img/background.jpg" class="d-block w-100" style="height: 100vh; object-fit: cover;"
              alt="Third Slide">
          </div>
          <!-- Slide 4 -->
          <div class="carousel-item">
            <img src="assets/assets/img/parkiran.jpg" class="d-block w-100" style="height: 100vh; object-fit: cover;"
              alt="Fourth Slide">
          </div>
          <!-- Slide 5 -->
          <div class="carousel-item">
            <img src="assets/assets/img/Ihramenya.jpg" class="d-block w-100" style="height: 100vh; object-fit: cover;"
              alt="Fifth Slide">
          </div>
          <!-- Slide 6 -->
          <div class="carousel-item">
            <img src="assets/assets/img/DataCenter.jpg" class="d-block w-100" style="height: 100vh; object-fit: cover;"
              alt="Sixth Slide">
          </div>
        </div>
        ...
        <div class="carousel-caption d-flex flex-column justify-content-center align-items-center text-center">
          <div class="text-container bg-dark bg-opacity-50 p-4 rounded custom-bg-size">
            ...
            <a href="#about" class="text-decoration-none text-primary responsive-text-medium"
              style="transition: transform 0.3s, color 0.3s;"
              onmouseover="this.style.transform='scale(1.1)'; this.style.color='#5693d1';"
              onmouseout="this.style.transform='scale(1)'; this.style.color='#72a7df';">
          ...
          <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
            <div class="image-wrapper">
              <div class="images position-relative" data-aos="zoom-out" data-aos-delay="400">
                <img src="assets/assets/img/background.jpg" alt="Business Meeting"
            ...
            <div class="contact-form">
              ...
              <form id="emailForm" onsubmit="sendEmail(); return false;">
                <div class="row gy-4">
                  ...
                  <div>
                    <textarea class="form-control" name="message" id="message" rows="6" placeholder="Pesan"
                      required></textarea>
                  </div>
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-6 col-md-6 footer-about">
          ...
          <div class="social-links d-flex mt-4">
            ...
            <a
              href="https://www.instagram.com/dinkominfotik.brebes?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="><i
