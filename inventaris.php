...
$query = "
    ...
    AND tempat_lokasi = 'Dinkominfotik Kab. Brebes'
";
...
<div class="col-lg-12">
    <div class="row">
        ...
        <a href="inventaris_ruangan.php?id_lokasi=<?= $id_lokasi ?>&nama_lokasi=<?= urlencode($nama_lokasi) ?>" class="text-decoration-none text-dark">
